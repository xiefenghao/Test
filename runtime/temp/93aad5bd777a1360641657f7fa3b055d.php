<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"E:\xamp\htdocs\ht\public/../application/admin\view\index\welcome.html";i:1581685404;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	<form action="<?php echo url('admin/index/welcome1'); ?>" method="post" >
		<input type="text" name="imagepath">
		<input type="submit" value="tjia">
	</form>
