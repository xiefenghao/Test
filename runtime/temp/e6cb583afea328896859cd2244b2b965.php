<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"E:\wamp64\www\ht\public/../application/admin\view\index\productcategory.html";i:1571400998;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
var setting = {
	...
	callback: {
		...
		$.ajax({
		url:"<?php echo url("admin/index/productdel"); ?>",
		type:'post',
		data:{id:treeNode.id},
		dataType:'json',
		async:false,
