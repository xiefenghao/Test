<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"E:\wamp64\www\ht\public/../application/admin\view\index\recordshare.html";i:1569504056;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
  <div class="text-c"> 日期范围：
    <input type="text" onfocus="WWdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true});" id="datemin" class="input-text Wdate" style="width:120px;">
    -
