<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"E:\xamp\htdocs\ht\public/../application/index\view\login\collect2.html";i:1604317391;}*/ ?>
  ...
  <table id="cartTable">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="goods"><img src="/ht/public/<?php echo $date['image']; ?>" alt="" /><span><?php echo $date['name']; ?></span></td>
        <td class="price"><?php echo $date['curprice']; ?></td>
        <td class="count"><span class="reduce">-</span>
          <input class="count-input" type="text" value="<?php echo $date['num']; ?>"/>
          <span class="add">+</span></td>
        <td class="subtotal"><?php echo $date['num']*$date['curprice']; ?></td>
...
<?php endforeach; endif; else: echo "" ;endif; ?>
  ...
  <div class="foot" id="foot">
    ...
    <div class="fr closing" id="js"  onclick="jump()">结 11算</div>
      <form action="<?php echo url('login/pay1'); ?>">
  <input type="hidden" id="num" value="" name="num1">
   
   <input type="submit" name="" value="结 算">
   </form>
