<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"E:\xamp\htdocs\ht\public/../application/admin\view\index\adminroleadd1.html";i:1582899365;}*/ ?>
﻿<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="page-container">
	<form action="<?php echo url('admin/index/addrole'); ?>" method="post" class="form form-horizontal" id="form-admin-role-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>角色名称(名称)：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="roleName" name="title">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">节点名称路径：</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
				<input type="submit" name="" value="节点添加">
			</div>
		</div>
	</form>
</article>
