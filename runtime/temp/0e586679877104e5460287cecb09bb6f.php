<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"E:\xamp\htdocs\ht\public/../application/index\view\party\index.html";i:1602682903;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
	<meta charset="utf-8">
            ...
            <div class="aui-content-menu">
                ...
                <div class="aui-content-menu-head">
                    <div class="aui-content-menu-head-list">
                        ...
                        <a href="<?php echo url('index/index/show2'); ?>?id=<?php echo $vo['id']; ?>"><?php echo $vo['name']; ?></a>
