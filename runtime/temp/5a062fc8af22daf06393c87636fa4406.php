<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"E:\xamp\htdocs\ht\public/../application/admin\view\index\picturelist.html";i:1578206026;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<a class="btn btn-primary radius" href='<?php echo url("admin/index/picturedel"); ?>' ><i class="Hui-iconfont">&#xe600;</i> 删除无效图片</a>
/ht/public/static
__PUBLIC__/static
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" onclick="picture_add('添加图片','<?php echo url('admin/index/pictureadd'); ?>')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加图片</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
	<div class="mt-20">
...
// function myFunction(){
// $.ajax({
// 		url:"<?php echo url("admin/index/picturedel"); ?>",
// 		type:'get',
