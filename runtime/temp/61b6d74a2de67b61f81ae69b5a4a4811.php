<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"E:\xamp\htdocs\ht\public/../application/index\view\index\shop5.html";i:1603199979;}*/ ?>
...
<div class="wrap">  
  ...
  <div class="imgs">    
    ...
    <div id="div_box-right" style="padding-left: 90px;padding-top:100px;vertical-align:bottom;">
           ...
           <div id="bottom">
                <p>价格： <font>￥ <span id='price'>5288</span>.00</p>
           ...
           <div id="wrap">
            ...
            <div id="div_box-right-7"  onselectstart="return false;">
                <span>数量</span>
                <div id="div_box-right-7-div-1"><span id="count" class="num-jian">1</span></div>
...
<script type="text/javascript">
    ...
    var wrap=biger.parentNode; 
     ...
     var imgArr=[    
        {"path":"/ht/public/static/1.jpg"},  
        {"path":"/ht/public/static/2.jpg"},  
        {"path":"/ht/public/static/6.jpg"},  
        {"path":"/ht/public/static/4.jpg"},  
        {"path":"/ht/public/static/5.jpg"}   
    ];  
    ...
    main.onmousemove=function(e){   
        ...
        pagex=pagex-wrap.offsetLeft-mask.offsetWidth/4;;    
        pagey=pagey-wrap.offsetTop-mask.offsetHeight/4; 
        if(pagex<0){    
            pagex=0;    
        }   
        if(pagey<0){    
