<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"E:\wamp64\www\ht\public/../application/admin\view\index\articleadd.html";i:1569497028;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true});" id="commentdatemin" name="commentdatemin" class="input-text Wdate">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">评论结束日期：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true});" id="commentdatemax" name="commentdatemax" class="input-text Wdate">
			</div>
		</div>
		<div class="row cl">
...
<script type="text/javascript" src="/ht/public/static/img/webuploader/0.1.5/webuploader.min.js"></script> 
<script type="text/javascript" src="/ht/public/static/img/ueditor/1.4.3/ueditor.config.js"></script> 
<script type="text/javascript" src="/ht/public/static/img/ueditor/1.4.3/ueditor.all.min.js"> </script> 
<script type="text/javascript" src="/ht/public/static/img/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
