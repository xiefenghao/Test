<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"E:\xamp\htdocs\ht\public/../application/admin\view\index\feedbacklist.html";i:1570531827;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<tbody>
				<tr class="text-c">
					...
					<td>1</td>
					<td><a href="javascript:;" onclick="member_show('张三','member-show.html','10001','360','400')"><i class="avatar size-L radius"><img alt="" src="/ht/public/static/css/images/ucnter/avatar-default-S.gif"></i></a></td>
