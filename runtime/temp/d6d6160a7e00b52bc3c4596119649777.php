<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"E:\xamp\htdocs\ht\public/../application/admin\view\index\productbrand.html";i:1569503294;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<table class="table table-border table-bordered table-bg table-sort">
			...
			<tbody>
				<tr class="text-c">
					...
					<td class="text-l"><img title="国内品牌" src="/ht/public/static/js/images/cn.gif"> 东鹏</td>
